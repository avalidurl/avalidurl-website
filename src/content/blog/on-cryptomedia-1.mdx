...
<div class="mirror-embed-wrapper">
  ...
  <div class="mirror-fallback">
    <p><a href="https://j.mirror.xyz/uVGCCwwm3k341lPpxaJmHTZROESVse9Pe_rmbiuUAC0" target="_blank" rel="noopener noreferrer">View Mirror Post: Crowdfund $ESSAY →</a></p>
  </div>
</div>

<style>
.mirror-embed-wrapper {
  margin: 2rem 0;
  border-radius: 12px;
  overflow: hidden;
...
.mirror-fallback a:hover {
  color: #1d4ed8;
  text-decoration: underline;
}

/* Show fallback if iframe fails to load */
.mirror-iframe:not([src]) + .mirror-fallback,
.mirror-iframe[src=""] + .mirror-fallback {
  display: block;
}
